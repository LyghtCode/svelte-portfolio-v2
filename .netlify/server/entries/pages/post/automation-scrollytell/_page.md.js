...
/* empty css                                                      *//* empty css                                                     */import { C as Code } from "../../../../chunks/Code.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Layout, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign($$props, metadata), {}, {
      default: () => {
        return `<p>I\u2019ve always been interested in data visualization, and my most recent
...
${validate_component(Code, "Code").$$render(
          ...
          {
            default: () => {
              return `<pre class="${"language-r"}"><!-- HTML_TAG_START -->${`<code class="language-r">plot <span class="token operator">&lt;-</span> data <span class="token percent-operator operator">%>%</span>
...
<p>But wait, what\u2019s that ${validate_component(HighlightFromProp, "HighlightFromProp").$$render(
          $$result,
          {

...
/* empty css                                                     */import { T as TableHandler } from "../../../../chunks/TableHandler.js";
...
${validate_component(Layout, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign($$props, metadata), {}, {
    default: () => {
      return `<p>On July 17, Rice University announced <a href="${"https://coronavirus.rice.edu/news/message-president-leebron-july-17"}" rel="${"nofollow"}">its
plan</a>
...
Times</a>):</p>
${validate_component(TableHandler, "TableHandler").$$render(
        $$result,
        {
